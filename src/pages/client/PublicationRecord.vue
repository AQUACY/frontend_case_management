    ...
    <q-card>
      <q-card-section>
        ...
        <p class="text-italic q-mb-md">
          ...
          it will be most helpful if we can refer to this completed publication record during our
          review of your summary of contributions draft.
        </p>
      </q-card-section>
      <q-form @submit.prevent="onSubmit" class="q-gutter-md">
        ...
        <q-card-section>
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-8">
              <q-input
                v-model="form.notes_technical_reports"
                type="textarea"
                label="Notes"
                outlined
              />
        ...
        <q-card-section>
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-8">
              <q-input
                v-model="form.notes_granted_patents"
                type="textarea"
                label="Notes"
                outlined
              />
